# Código iniciará com um try para ocorra a inserção de um valor icoerente com a pergunta seja informado
try:
...
# Agora temos a primeira condição estabelecida e nela indicamos que para ser aprovado a media tem que ser igual a  60 e menor ou igual a 100
        print("Você está aprovado, sua media foi: ", MD)
#  Agora com a segunda condição que sera executada caso a primeira não seja atendida. Ela consiste em analisar se a media foi maior ou igual a 20 e menor que 60, e caso a nota do aluno se enquadre ele ira ter que fazer a prova final.
# O  codigo vai calcular MD com NAF(Nota da prova final) e mostrar se depois da prova final o aluno esta aprovado ou reprovado
